...
public class PinyinIME extends InputMethodService {
	...
	private void iDataSoftKeyEvent(int keyCode) {
		...
		case IDATA_KEY_DISCONNECT_BLUETOOTH:
			BluetoothService.removePairDevice();
			break;
		case IDATA_KEY_FUNCTION:
			showFunctionMenu();
			break;
		case IDATA_KEY_OPEN_SCAN:
			BluetoothService.discoverDevice();
			break;
		default:
			break;
		}
	...
	public void showFunctionList() {
		...
		builder.setItems(R.array.idata_commands, new DialogInterface.OnClickListener() {
	...
	public void showFunctionMenu() {
		...
		builder.setSingleChoiceItems(R.array.idata_config, -1, new OnClickListener() {
